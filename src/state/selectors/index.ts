...
export const cpmSelector = (state: LevelState) => {
  ...
  return Math.floor(index / minutes)
}
...
export const levelSelector = (state: LevelState) => state.level

export const hasStartedSelector = (state: LevelState) => state.level !== null
